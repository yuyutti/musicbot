...
const { notice_command, notice_playing, join_left, notice_vc, error_log, express_error, discordapi_error } = require('./src/notification');
const resxData = require('./src/resx-parse');
const fs = require('fs');
